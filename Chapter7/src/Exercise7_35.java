...
public class Exercise7_35 {
    public static void main(String[] args) {
        ...
        char[] word = generateRandomWordToArray();
        ...
        do {
            ...
            if (isComplete(hiddenWord)){
                ...
                if (continuePlay == 'y'){
                    word = generateRandomWordToArray();
                    System.out.println(Arrays.toString(word));
    ...
    public static char[] generateRandomWordToArray(){
        String[] strings = {"write", "hangman", "game", "randomly", "generates", "word", "prompts",
                "guess", "displayed"};
