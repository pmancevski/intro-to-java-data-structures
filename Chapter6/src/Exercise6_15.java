public class Exercise6_15 {
    public static void main(String[] args) {
        System.out.println("Taxable Income\tSingle\tMarried Joint or Qualifying Widow(er)\tMarried Separate\t" +
                "Head of House hold");

        for (int taxableIncome = 50000; taxableIncome <= 60000; taxableIncome += 50) {
            System.out.printf("%10d",  taxableIncome);
            for (int status = 0; status <= 3; status++) {
                //formating number for printf
                int formatingNumber;
                switch (status) {
                    case 0 ->  formatingNumber = 12;
                    case 1 -> formatingNumber = 20;
                    case 2 -> formatingNumber = 30;
                    case 3 -> formatingNumber = 23;
                    default -> formatingNumber = 0;
                }
                System.out.printf("%" + formatingNumber + "d", computeTax(status, taxableIncome));
            }
            System.out.println();
        }
    }
